 ...
 */
export function onInsertVideoWhenTargetIsVisible (target, videoElement, options = { pauseOnNoVisible: true }) {
 ...
 * @param {HTMLVideoElement} videoElement
 */
export async function autoplayVideoElement (videoElement) {
  try {
